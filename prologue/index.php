					...
					<section id="contact" class="four">
						<div class="container">
							...
							<form method="post" action="#">
								<div class="row">
									<div class="6u 12u$(mobile)"><input type="text" name="nombre" placeholder="Name" /></div>
									<div class="6u$ 12u$(mobile)"><input type="text" name="email" placeholder="Email" /></div>
									<div class="6u$ 12u$(mobile)"><input type="password" name="clave" placeholder="Ingrese su Clave" /></div>
									<div class="12u$">
...
//4.- INVOCAMOS AL METODO SOAP, PASANDOLE EL PARAMETRO DE ENTRADA
		$result = $client->call('login',array($_POST['nombre'],$_POST['email'],$_POST['clave']));
		//var_dump($_POST);
