...
class cd
{
  	...
  	public function mostrarDatos()
	{
	 ...
	 public function InsertarCd0()
	 {
	 	 ...
	 	 public static function InsertarElCd2($dato)
	 {
				$objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso(); 
				$consulta =$objetoAccesoDato->RetornarConsulta("INSERT into cds (titel,interpret,jahr)values('$dato->titulo','$dato->cantante','$dato->fecha')");
				$consulta->execute();
				return $objetoAccesoDato->RetornarUltimoIdInsertado();
