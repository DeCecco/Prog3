	...
	//5.- CHECKEAMOS POSIBLES ERRORES AL INVOCAR AL METODO DEL WS 
		if ($client->fault) {
			...
			if ($err) {//MOSTRAMOS EL ERROR
				...
				{
					echo "<tr>
							<form method='post' action='baja.php' ><td><input type='text' name='id' value='".$user['id']."' readonly></td>
							<td><input type='text' name='nombre' value='".$user['nombre']."' readonly></td>
							<td><input type='text' name='clave' value='".$user['clave']."' readonly></td>
							<td><input type='text' name='email' value='".$user['mail']."' readonly></td>
