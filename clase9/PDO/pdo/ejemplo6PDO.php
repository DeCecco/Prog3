      ...
      <div class="container">
            ...
            <?php
              ...
              try
              {
                ...
                echo "<h3> fetchAll(PDO::FETCH_CLASS, 'cd');</h3></br>";//primer dato una variable y segundo una clase (transforma el array en un array de objetos. Se puede recorrer y mostrar datos)
