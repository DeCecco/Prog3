...
class productos
{
	public $id;
 	public $nombre;
  	...
  	public function BorrarProductoi($dato)
	 {
	...
	//	public array PDOStatement::fetchAll ([ int $fetch_style [, mixed $fetch_argument [, array $ctor_args = array() ]]] )
	 ...
	 {
				$objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso(); 
				$consulta =$objetoAccesoDato->RetornarConsulta("SELECT *  FROM `misusuarios` WHERE  `clave`=:clave and `correo`=:mail and `nombre`=:nombre ;");
	  ...
	  public static function ListadodeProductos()
	 {
				$objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso(); 
