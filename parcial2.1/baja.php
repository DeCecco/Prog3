...
//4.- INVOCAMOS AL METODO SOAP, PASANDOLE EL PARAMETRO DE ENTRADA
		$result = $client->call('listadoprodu');
		//echo $btn;
		if ($btn=='Baja'){
			//echo 'entro';
			error_reporting(0);
		...
		if ($client->fault) {
			...
			if ($err) {//MOSTRAMOS EL ERROR
				...
				echo "<table border='1' width='70%' >
						<tr>
							<th>ID</th><th>Nombre</th><th>Porcentaje</th><th>Baja</th><th></th><th></th>
						</tr>";
				foreach($result as $user)
				{
					echo "<tr>
							...
							<td><input required type='text' name='clave' value='".$user['porcentaje']." %' readonly></td>"	;				
							if($_SESSION['tipo']!='comprador'){ 
							echo "<td><input type='submit' name='boton' value='Baja'></td>";
							 }
							echo "</form>
